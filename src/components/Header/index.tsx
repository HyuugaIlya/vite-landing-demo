...
import { TRefs } from '../../App';

import { Menu } from '../Common/menuBurger';
...
export const Header: FC<TProps> = ({ isMenuOpen, setMenuOpen, isScroll, refs }) => {
    return (
        <div className={clsx(styles.header, isScroll && styles.scroll)}>
            <div className={styles.header__row}>
                ...
                <div className={clsx(styles.header__logo, isMenuOpen && styles.active)}>
                    <svg fill="#444a5a" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" stroke="#444a5a" strokeWidth="0.00024000000000000003"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
